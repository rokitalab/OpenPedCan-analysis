...
This project is maintained by the [Rokita Lab](https://rokitalab.com/) at [Children's National Hospital](https://www.childrensnational.org/).
...
OpenPedCan project includes 10,414 TCGA RNA-Seq samples (716 normal and 9698 tumor) from [33 cancer types](https://github.com/rokitalab/OpenPedCan-Project/blob/0a5c14705a385c99a6a16e34e932e94009b7a11c/analyses/molecular-subtyping-integrate/results/tcga_cancer_groups.tsv) in the release.
...
[Here](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/analyses/molecular-subtyping-integrate/results/pediatric_cancer_groups.tsv) is a detailed table of pediatric cancer groups in the current release.
...
The `histologies-base.tsv` file is utilized together with these matrices to run the [pre-release QC](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/data-pre-release-qc) to ensure all samples from the histologies file are represented in the data files, if there is output.
3. The [generate-analysis-files.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/generate-analysis-files.sh) script is run next; this module creates independent specimen lists and analysis output required for molecular subtyping. 
4. The [run-for-subtyping.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/run-for-subtyping.sh) script is run to subtype all samples and add this information to a final `histologies.tsv` file used in the data release.
5. Once all release files are generated, the [create-subset-files](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/create-subset-files) module is run to create smaller subsets of the data release files for use in continuous integration.

|      Analysis Type     |                                                            Workflow Script                                                            |                                                                  Analysis Module                                                                 | Runtime on EC2 m6i.4xlarge (minutes) |                                                                 Comment                                                                 |
|:----------------------:|:-------------------------------------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------------------:|:------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------------:|
| Data pre-release QC    |                                                                                                                                       | [data-pre-release-qc](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/data-pre-release-qc)                         | 21.013                               | Performs QC on harmonized pre-release datasets, including primary matrices, before being utilized in all data release analysis modules. |
| Analysis pre-release   | [generate-analysis-files.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/generate-analysis-files.sh) | [copy_number_consensus_call](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/copy_number_consensus_call)           | 67.683                               | Run independently to create the data release copy number consensus file                                                                 |
| Analysis pre-release   | [generate-analysis-files.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/generate-analysis-files.sh) | [independent-samples](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/independent-samples)                         | 00.200                               | Generated using the `histologies-base` file for analysis pre-release and molecular subtyping modules.                                   |
| Analysis pre-release   | [generate-analysis-files.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/generate-analysis-files.sh) | [fusion_filtering](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/fusion_filtering)                               | 81.433                               |                                                                                                                                         |
| Analysis pre-release   | [generate-analysis-files.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/generate-analysis-files.sh) | [run-gistic](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/run-gistic)                                           | 56.950                               |                                                                                                                                         |
| Analysis pre-release   | [generate-analysis-files.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/generate-analysis-files.sh) | [focal-cn-file-preparation](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/focal-cn-file-preparation)             | 53.217                               |                                                                                                                                         |
| Analysis pre-release   | [generate-analysis-files.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/generate-analysis-files.sh) | [fusion-summary](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/fusion-summary)                                   | 00.233                               |                                                                                                                                         |
| Analysis pre-release   | [generate-analysis-files.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/generate-analysis-files.sh) | [tmb-calculation](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/tmb-calculation)                                 | 13.600                               |                                                                                                                                         |
| Analysis pre-release   | [generate-analysis-files.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/generate-analysis-files.sh) | [gene-set-enrichment-analysis](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/gene-set-enrichment-analysis)       | 8.533                                |                                                                                                                                         |
| Analysis pre-release   | [generate-analysis-files.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/generate-analysis-files.sh) | [tp53_nf1_score](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/tp53_nf1_score)                                   | 17.001                               |                                                                                                                                         |
| Molecular subtyping    | [run-for-subtyping.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/run-for-subtyping.sh)             | [molecular-subtyping-MB](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/molecular-subtyping-MB)                   | 09.150                               |                                                                                                                                         |
| Molecular subtyping    | [run-for-subtyping.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/run-for-subtyping.sh)             | [molecular-subtyping-CRANIO](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/molecular-subtyping-CRANIO)           | 06.083                               |                                                                                                                                         |
| Molecular subtyping    | [run-for-subtyping.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/run-for-subtyping.sh)             | [molecular-subtyping-EPN](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/molecular-subtyping-EPN)                 | 07.117                               |                                                                                                                                         |
| Molecular subtyping    | [run-for-subtyping.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/run-for-subtyping.sh)             | [molecular-subtyping-embryonal](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/molecular-subtyping-embryonal)     | 05.650                               |                                                                                                                                         |
| Molecular subtyping    | [run-for-subtyping.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/run-for-subtyping.sh)             | [molecular-subtyping-chordoma](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/molecular-subtyping-chordoma)       | 01.717                               |                                                                                                                                         |
| Molecular subtyping    | [run-for-subtyping.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/run-for-subtyping.sh)             | [molecular-subtyping-EWS](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/molecular-subtyping-EWS)                 | 00.083                               |                                                                                                                                         |
| Molecular subtyping    | [run-for-subtyping.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/run-for-subtyping.sh)             | [molecular-subtyping-neurocytoma](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/molecular-subtyping-neurocytoma) | 00.050                               |                                                                                                                                         |
| Molecular subtyping    | [run-for-subtyping.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/run-for-subtyping.sh)             | [molecular-subtyping-HGG](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/molecular-subtyping-HGG)                 | 08.383                               |                                                                                                                                         |
| Molecular subtyping    | [run-for-subtyping.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/run-for-subtyping.sh)             | [molecular-subtyping-LGAT](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/molecular-subtyping-LGAT)               | 12.517                               |                                                                                                                                         |
| Molecular subtyping    | [run-for-subtyping.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/run-for-subtyping.sh)             | [molecular-subtyping-ATRT](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/molecular-subtyping-ATRT)               | 00.067                               |                                                                                                                                         |
| Molecular subtyping    | [run-for-subtyping.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/run-for-subtyping.sh)             | [molecular-subtyping-PB](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/molecular-subtyping-PB)               |                                |                                                                                                                                         |
| Molecular subtyping    | [run-for-subtyping.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/run-for-subtyping.sh)             | [molecular-subtyping-NBL](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/molecular-subtyping-NBL)                 | 03.467                               |                                                                                                                                         |
| Molecular subtyping    | [run-for-subtyping.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/run-for-subtyping.sh)             | [molecular-subtyping-pathology](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/molecular-subtyping-pathology)     | 00.567                               |                                                                                                                                         |
| Molecular subtyping    | [run-for-subtyping.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/run-for-subtyping.sh)             | [molecular-subtyping-integrate](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/molecular-subtyping-integrate)     | 00.150                               |                                                                                                                                         |
| Analysis pre-release   | [run-for-subtyping.sh](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/scripts/run-for-subtyping.sh)             | [independent-samples](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/independent-samples)                         | 00.412                               | Generated using the `final histologies` file for each cohort and each cohort-cancer_group for downstream analysis modules.              |
| continuous integration |                                                                                                                                       | [create-subset-files](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/create-subset-files)                         | 41.500                               |                                                                                                                                         |
...
Use the [data issue template](https://github.com/rokitalab/OpenPedCan-Project/issues/new?assignees=&labels=data&template=data-question.md&title=) to file issues if you have questions about or identify issues with OpenPedCan data.
...
Check the existing [issues](https://github.com/rokitalab/OpenPedCan-Project/issues) to identify these.
...
Check the existing [issues](https://github.com/rokitalab/OpenPedCan-Project/issues) before proposing an analysis to see if something similar is already planned.
...
Analyses should be performed within the project's [Docker container](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/Dockerfile).
We use a single monolithic container in these analyses for ease of use.
If you need software that is not included, please edit the Dockerfile to install the relevant software or file a [new issue on this repository](https://github.com/rokitalab/OpenPedCan-Project/issues/new/choose) requesting assistance.

#### Pull Request Model

Analyses are added to this repository via [Pull Requests](https://github.com/d3b-center/OpenPedCan-analysis/compare.
**Please read the [Pull Request section of the contribution guidelines](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/CONTRIBUTING.md#pull-requests) carefully.**
...
To add dependencies that are required for your analysis to the project Docker image, you must alter the project [`Dockerfile`](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/Dockerfile).
The `Dockerfile` can be directly edited to install dependencies, if you are developing using a branch on the [rokitalab/OpenPedCan-Project](https://github.com/rokitalab/OpenPedCan-Project) repository.
If you are developing using a branch on your fork of the d3b-center/OpenPedCan-analysis repository, create a branch on the d3b-center/OpenPedCan-analysis repository to edit the `Dockerfile` to install dependencies, e.g. <https://github.com/d3b-center/OpenPedCan-analysis/pull/36>, so [the GitHub action for checking docker image build](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/.github/workflows/build-docker.yml) can run with the Docker Hub credentials saved in the d3b-center/OpenPedCan-analysis repository.
...
If you need assistance adding a dependency to the Dockerfile, [file a new issue on this repository](https://github.com/rokitalab/OpenPedCan-Project/issues/new) to request help.
...
```bash
docker run --name <CONTAINER_NAME> -d -e PASSWORD=pass -p 8787:8787 -v $PWD:/home/rstudio/OpenPedCan-Project pgc-images.sbgenomics.com/d3b-bixu/openpedcanverse:latest
```
...
If you set the `PWD:/home/rstudio/OpenPedCan-Project` above, then you can navigate to `home/rstudio/OpenPedCan-Project` and begin.
...
```bash
docker run --name <CONTAINER_NAME> -d -e PASSWORD=pass -p 80:8787 -v $PWD:/home/rstudio/OpenPedCan-Project pgc-images.sbgenomics.com/d3b-bixu/openpedcanverse:latest
```
...
We use GitHub Actions (GA) to ensure that the project Docker image will build if there are any changes introduced to the [`Dockerfile`](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/Dockerfile) and that all analysis code will execute.
...
You can see how this was done by viewing [this module](https://github.com/rokitalab/OpenPedCan-Project/tree/dev/analyses/create-subset-files).
...
For an analysis to be run in a Github Actions workflow, it must be added to [`.github/continuous_integration.yml`](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/.github/workflows/continuous_integration.yml). Here is an example of a step in that workflow:
...
To add a new analysis job, take the template below and value each missing prompt, then add it to [`.github/continuous_integration.yml`](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/.github/continuous_integration.yml).
...
Per [the contribution guidelines](https://github.com/rokitalab/OpenPedCan-Project/blob/dev/CONTRIBUTING.md#size-and-composition-of-pull-requests), each script or notebook should be added via a separate pull request.
