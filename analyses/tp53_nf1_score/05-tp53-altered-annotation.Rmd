...
tp53_alterations_score_wide %>% 
  left_join(histology[,c("Kids_First_Biospecimen_ID", "match_id")]) %>%
  select("Kids_First_Biospecimen_ID", "match_id", names(tp53_alterations_score_wide)) %>%
  arrange(match_id) %>%
