...
This notebook updates the current [manuscript metadata](https://github.com/d3b-center/OpenPedCan-methods/blob/main/content/metadata.yaml) such that the authors are ordered in the following way:

* The first 3 and last 2 authors, are pinned to reflect scholarship and contributor roles that are not captured in the Git history of this repository (e.g., substantive analytical code review, conceptualization, supervision, or project administration).
...
```{r}
manuscript_metadata_url <- "https://raw.githubusercontent.com/d3b-center/OpenPedCan-methods/main/content/metadata.yaml"
...
code_contributor_positions <- 1:length(code_contributors) + 3
