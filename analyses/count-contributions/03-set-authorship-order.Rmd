...
This notebook updates the current [manuscript metadata](https://github.com/d3b-center/OpenPedCan-manuscript/blob/main/content/metadata.yaml) such that the authors are ordered in the following way:
...
```{r}
manuscript_metadata_url <- "https://raw.githubusercontent.com/d3b-center/OpenPedCan-manuscript/main/content/metadata.yaml"
