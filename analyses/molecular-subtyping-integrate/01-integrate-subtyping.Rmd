...
histology_cg <- histology %>%
  ...
  dplyr::mutate(cancer_group = case_when(
    ...
    cancer_group == "Brain Lower Grade Glioma" ~ "Low-grade glioma",
    ...
    cancer_group == "Glioneuronal tumor" ~ "Glial-neuronal tumor",
...
efo_mondo <- read_tsv(file.path(data_dir, "efo-mondo-map-previous-release.tsv"))
