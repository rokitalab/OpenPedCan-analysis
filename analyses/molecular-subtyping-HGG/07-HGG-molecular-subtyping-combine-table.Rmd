...
methyl_df <- hgg_meta %>% 
  ...
  mutate(molecular_subtype_methyl = case_when(
    dkfz_v12_methylation_subclass_score >= 0.8 & grepl("GBM_", dkfz_v12_methylation_subclass) ~ "HGG, H3 wildtype",
    dkfz_v12_methylation_subclass_score >= 0.8 & grepl("pedHGG_", dkfz_v12_methylation_subclass) ~ "HGG, H3 wildtype",
    dkfz_v12_methylation_subclass_score >= 0.8 & dkfz_v12_methylation_subclass == "DHG_G34"  ~ "DHG, H3 G35",
    dkfz_v12_methylation_subclass_score >= 0.8 & dkfz_v12_methylation_subclass == "DMG_K27"  ~ "DMG, H3 K28",
