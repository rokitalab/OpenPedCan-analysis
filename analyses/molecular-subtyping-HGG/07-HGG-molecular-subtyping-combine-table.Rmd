...
wildtype_df <- all_data_df %>%
  ...
  ## if there is no H3 mutation and methylation molecular subtype == "DMG, EFGR", assign sample molecular subtype as "DMG, EFGR"
  mutate(molecular_subtype = case_when(molecular_subtype_methyl == "DMG, EGFR" ~ "DMG, EGFR", 
