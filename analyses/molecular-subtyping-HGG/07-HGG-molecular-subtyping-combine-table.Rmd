...
lesions_subtypes_RNA <- lesions_subtypes %>% 
  select(Kids_First_Participant_ID, Kids_First_Biospecimen_ID_RNA, sample_id, id, CNS_region, age_at_diagnosis_yr, composition, molecular_subtype_methyl, molecular_subtype, 
...
lesions_subtypes_DNA <- lesions_subtypes %>% 
  select(Kids_First_Participant_ID, sample_id, id, CNS_region, age_at_diagnosis_yr, composition, molecular_subtype_methyl, molecular_subtype, 
...
lesions_subtypes_methyl <- lesions_subtypes %>% 
  select(Kids_First_Participant_ID, Kids_First_Biospecimen_ID_Methyl, sample_id, id, CNS_region, age_at_diagnosis_yr, composition, molecular_subtype_methyl, molecular_subtype) %>% 
