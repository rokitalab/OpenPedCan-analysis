...
gene_symbol_diffs <- opc_counts %>%
  ...
  ## add gtex rna
  dplyr::full_join(gtex_tpm, by = "gene_symbol") %>%
  dplyr::full_join(gtex_counts, by = "gene_symbol") %>%
#  dplyr::full_join(tcga_tpm, by = "gene_symbol") %>%
  dplyr::select(-gene_symbol) %>%
  dplyr::filter(is.na(OPC_COUNTS) | is.na(OPC_TPM) | is.na(GTEx_COUNTS) | is.na(GTEx_TPM) ) %>%
  #### | is.na(TCGA_TPM)
  dplyr::distinct()
