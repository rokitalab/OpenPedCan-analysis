...
ews_clinical <- clinical %>%
  filter(pathology_diagnosis == "Ewings Sarcoma" | (dkfz_v12_methylation_subclass == "EWS" & dkfz_v12_methylation_subclass_score >= 0.8))
...
# methyl map
methyl_map <- methyl_bs_ids_with_subtypes %>%
