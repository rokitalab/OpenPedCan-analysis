...
compiled_df <- compiled_df %>% 
  mutate(
    ...
    short_histology = case_when(
      sample_id == "7316-1723" ~ "EWS",
      sample_id == "7316-1746" ~ "EWS",
      sample_id == "7316-194" ~ "LGAT",
      sample_id == "7316-2151" ~ NA,
      sample_id == "7316-2857" ~ "EWS",
    ...
    broad_histology = case_when(
      ...
      sample_id == "7316-2151" ~ NA,
      sample_id == "7316-2857" ~ "Mesenchymal non-meningothelial tumor",
    ...
    Notes = case_when(sample_id %in% HOPE_df$sample_id ~ "Updated by manual curation of pathology_free_text_diagnosis", 
                      TRUE ~ Notes)
  ) %>% 
  distinct()
