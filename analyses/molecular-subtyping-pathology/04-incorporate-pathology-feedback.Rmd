...
compiled_df <- compiled_df %>%
    mutate(molecular_subtype = case_when(
      ...
      TRUE ~ molecular_subtype),
   harmonized_diagnosis = case_when(str_detect(molecular_subtype, "CHDM, poorly") ~ str_replace(molecular_subtype, "CHDM, ", "Chordoma, poorly"),
                                    str_detect(molecular_subtype, "CHDM, con") ~ str_replace(molecular_subtype, "CHDM, ", "Chordoma, con"),
