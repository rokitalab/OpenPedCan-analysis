...
all_subtype <- methly_subtyped %>%
  ...
  dplyr::mutate(molecular_subtype = case_when(
    grepl("To be classified", molecular_subtype) & !is.na(molecular_subtype_methyl) & 
      (molecular_subtype_methyl != "LGG, To be classified") ~ molecular_subtype_methyl,
    is.na(molecular_subtype) & !is.na(molecular_subtype_methyl) ~ molecular_subtype_methyl,
    grepl("wildtype", molecular_subtype) & !is.na(molecular_subtype_methyl) & 
      (molecular_subtype_methyl != "LGG, To be classified") ~ molecular_subtype_methyl,
    TRUE ~ molecular_subtype)) %>%
