...
methyl_clinical <- clinical_file %>%
  filter(Kids_First_Biospecimen_ID %in% methly_subtyped$Kids_First_Biospecimen_ID_Methyl) %>%
  select(Kids_First_Biospecimen_ID_Methyl = Kids_First_Biospecimen_ID, pathology_diagnosis)
