...
starfusion %>% filter(str_detect(FusionName, "^TTYH1"), 
...
dgd_fusion %>% filter(str_detect(FusionName, "^TTYH1"),
                      str_detect(LeftBreakpoint, "^chr19"),
		      str_detect(RightBreakpoint, "^chr19"))

# keep samples with with at least one break point within 
# genomic region: `chr19:53,627,063-53,788,978` 
ttyh1_fusion_biospecimens <-  ttyh1_fusion_biospecimens %in% arriba_ttyh1_fusions
```
