...
fusions_summary_df <- list(ttyh1_fusions,
  ...
  # Filter out specific MN1--PATZ1 fusion based on comment: https://github.com/AlexsLemonade/OpenPBTA-analysis/pull/788#discussion_r495212879 and MN1 self-fusion (other hist)
  filter(!(MN1_fusions %in% c("MN1--PATZ1", "MN1--MN1"))) %>% 
...
subtypes_df <- relevant_clinical_data %>%
  filter(match_id %in% match_df$match_id) %>%
