...
sed 's/\t/,/'g  results/long_n_tpm_mean_sd_quantile_group_wise_zscore.tsv | \
    dasel -r csv  -w json > results/long_n_tpm_mean_sd_quantile_group_wise_zscore.json

sed 's/\t/,/'g  results/long_n_tpm_mean_sd_quantile_gene_wise_zscore.tsv | \
        dasel -r csv  -w json > results/long_n_tpm_mean_sd_quantile_gene_wise_zscore.json
